...
const ModalPage= ({isOpen,onClose,onSubmit,title,footer,body,actionLabel,disabled,secondaryAction,secondaryActionLabel}) => {
    ...
    className='flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70 '>
      ...
      `}>
        ...
        >
          {/* Headers */}
          <div
          className='flex items-center p-6 rounded-t justify-center relative border-b-2'
          >
          ...
          {/* Body */}
          <div className='relative p-6 flex-auto md:px-16'>
            {body}
          </div>
          {/* Footer */}
          <div className='flex flex-col gap-2 p-6 md:px-16'>
            <div className='items-start justify-center gap-4'>
              {
